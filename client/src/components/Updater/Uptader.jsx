...
//     if (input.name.length > 40) err.name = "Name must be under 40 characters.";
    ...
    const handleSubmit = e => {
        ...
        if (! Object.keys(errors).length) {
            ...
            const modifiedDog = {
                ...
                image: input.image.length ? input.image.trim() : undefined,
                    ...
                    <form className="updaterFields" onSubmit={e => handleSubmit(e)}>
                        ...
                        <div className="areaInicio">
                            ...
                            <div className="firstFields">
                                <input className="createField nameInput" name="nombre" type="text" value={input.name} onChange={handleChange} placeholder="Breed name" />
